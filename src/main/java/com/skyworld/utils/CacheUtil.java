...
public class CacheUtil {
	...
	public static void putLockOnKey(String cacheName, Object key, Object value) {
	...
	public static <T> T getLockOnKey(String cacheName, String key) {
		Cache cache = getCache(cacheName);
		try {
			cache.acquireReadLockOnKey(key);
			Element el = cache.get(key);
			if (el == null) {
				throw new RuntimeException("value is null , cacheName:" + cacheName + "--key:" + key);
			}
			return el != null ? (T) el.getObjectValue() : null;
		} finally {
